...
export default function Allrooms(){
  ...
  return (
    ...
    selectedFilters.roomType.some(
      (type) => type.toLowerCase() === room.roomType.toLowerCase()
    )
  );
};
    ...
    return(
        ...
        <div className='flex flex-col items-start text-left'>
            ...
            <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantages of our limited-time offers and special packages to enhance your stay and create unforgettable memmories.</p>
        </div>
